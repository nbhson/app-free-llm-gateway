...
export const providers: Record<string, Provider> = {
  ...
  "kiosapi": OPENAI({ id: "kiosapi", baseUrl: "https://router.kiosapi.com/v1" }), // 20 free models (https://kiosapi.com/pricing, llm24 2026-09)
...
export const providerMeta: Record<string, { name: string; tier: string; tier_type: string; caps: string[]; noCard: boolean }> = {
  ...
  kiosapi: { name: "KiosAPI", tier: "Permanent Free", tier_type: "permanent", caps: ["text","reasoning","code","vision","embedding"], noCard: true },
...
export const modelAliases: Record<string, string[]> = {
  ...
  "qwen3.8-27b": ["kiosapi", "experientiallabs", "orcarouter", "modelscope"],
  "deepseek-v4-flash": ["kiosapi", "experientiallabs", "kiraai", "cline", "deepseek", "nvidia-nim"],
  ...
  "gpt-oss-20b:free": ["kiosapi", "unorouter", "openrouter"],
  ...
  "ling-3.0-flash-fin:free": ["kiosapi", "unorouter", "opencode", "kilo-code"],
  ...
  "qwen3-8b": ["freeai", "modelscope", "kiosapi"],
  // KiosAPI — 20 free models (https://kiosapi.com/pricing, llm24 2026-09, $0.00 in/out)
  "ling-3.0-flash-fin": ["kiosapi", "opencode", "kilo-code"],
  "oc/muse-spark-1.3-contributor": ["kiosapi"],
  "muse-spark-1.3-contributor": ["kiosapi"],
  "diffusiongemma-26b-a4b-it": ["kiosapi"],
  "oc/mimo-v2.5": ["kiosapi", "b-ai", "tokenharbor"],
  "nemotron-3-super-120b-a12b": ["kiosapi", "nvidia-nim"],
  "oc/nemotron-3.5-lightning": ["kiosapi", "opencode", "nvidia-nim"],
  "kiosapi/ling-3.0-flash-fin": ["kiosapi"],
  "kiosapi/glm-5.3-flash": ["kiosapi"],
  "kiosapi/glm-5.3": ["kiosapi"],
  "kiosapi/qwen3.8-flash": ["kiosapi"],
  "kiosapi/qwen3.8-27b": ["kiosapi"],
  "kiosapi/kimi-k3": ["kiosapi"],
  "kiosapi/laguna-s-2.1": ["kiosapi"],
  "kiosapi/muse-glimmer-30b": ["kiosapi"],
  "kiosapi/hy3": ["kiosapi"],
  "kiosapi/laguna-xs-2.1": ["kiosapi"],
  "kiosapi/nemotron-3-ultra-550b-a55b": ["kiosapi"],
  "kiosapi/deepseek-v4-flash": ["kiosapi"],
  "kiosapi/deepseek-v4-flash-0731": ["kiosapi"],
  "kiosapi/nemotron-3-super-120b-a12b": ["kiosapi"],
  "kiosapi/gpt-oss-20b": ["kiosapi"],
  "kiosapi/qwen3-8b": ["kiosapi"],
